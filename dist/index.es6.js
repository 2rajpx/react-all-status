...
var createState = function createState(stateName) {
  ...
  var createPropTypes = function createPropTypes(flag) {
    ...
    propTypes[valueName] = requiredProps.indexOf(valueName) !== -1 ? bool.isRequired : bool;
    propTypes[toggleName] = requiredProps.indexOf(toggleName) !== -1 ? func.isRequired : func;
    propTypes[activateName] = requiredProps.indexOf(activateName) !== -1 ? func.isRequired : func;
    propTypes[deactivateName] = requiredProps.indexOf(deactivateName) !== -1 ? func.isRequired : func;
    return propTypes;
  };
